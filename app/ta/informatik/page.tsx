...
export const metadata = getMetadata(title, 'Florian\'s TA material for Informatik');
    ...
    <Wrapper title={title} route='/ta/informatik/' updated='2024-12-18'>
      ...
      <ul>
        <li>
          <em>[17.12.2024]</em>
          <ul>
            <li>Uploaded <Link href='#quiz'>quiz slides</Link> from the last exercise session, thanks for participating!</li>
            <li>This was probably the last big update on here; thanks for the ride, <em>merry Christmas</em> and happy holidays!</li>
          </ul>
        </li>
        <li>
          <em>[29.10.2024]</em>
          <ul>
            <li>Added separate slide and handout <Link href='#material'>PDFs</Link> for each exercise session</li>
          </ul>
        </li>
        <li>
          <em>[22.10.2024]</em>
          <ul>
            <li>Added <Link href='#links'>C++ style guide</Link></li>
          </ul>
        </li>
        <li>
          <em>[25.09.2024]</em>
          <ul>
            <li>Added <Link href='#links'>useful links</Link></li>
          </ul>
        </li>
        <li>
      ...
      <ul>
        <li><Link target='_blank' href='https://lec.inf.ethz.ch/ifmp/2024/'>Course page</Link> with all the material that you can't find on here</li>
        <li><Link target='_blank' href='https://lec.inf.ethz.ch/ifmp/2024/guides/style/intro.html'>C++ style guide</Link> for beautiful code</li>
        <li><Link target='_blank' href='https://et.lecturers.inf.ethz.ch/subscriber/course/pWLMhQEDPZX2NJi39'>C++ tutorial</Link> offered by ETH</li>
        <li><Link target='_blank' href='https://pythontutor.com/cpp.html'>Python Tutor C++</Link> (beware, <span className='cpp-code'>std::cin</span> does not work!)</li>
      </ul>

      <h2>Contact</h2>
      <ul>
        <li><Link href='mailto:ffrauenfelde@student.ethz.ch'>ffrauenfelde@student.ethz.ch</Link></li>
        <li><Link href='mailto:florian.frauenfelder@inf.ethz.ch'>florian.frauenfelder@inf.ethz.ch</Link> (probably not going to work after December 2024)</li>
      </ul>
