  ...
  return process.env.VERCEL_ENV !== 'production' ? (
    <>
      ...
      <p style={{ fontSize: '1.5rem', fontStyle: 'italic' }}>
        I do not guarantee that anything on this version works as expected. If you want to see the normal, functional version, <Link style={{ color: 'red' }} href=''>click here</Link>.
      </p>
      <hr />
    </>
  ) : '';
